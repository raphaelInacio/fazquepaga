...
public class AllowanceService {
    ...
    public AllowanceService(AllowanceCalculator allowanceCalculator, TaskService taskService, UserRepository userRepository) {
        this.allowanceCalculator = allowanceCalculator;
        this.taskService = taskService;
        this.userRepository = userRepository;
    }

    public BigDecimal calculateValueForTask(String childId, String taskId) throws ExecutionException, InterruptedException {
        ...
        return allowanceCalculator.calculateTaskValue(targetTask, child.getMonthlyAllowance(), activeTasks, currentMonth);
    }
