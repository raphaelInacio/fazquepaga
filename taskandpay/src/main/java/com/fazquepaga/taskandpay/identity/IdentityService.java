...
public class IdentityService {
    ...
    public User completeOnboarding(String code, String phoneNumber) throws ExecutionException, InterruptedException {
    ...
    public User registerParent(CreateParentRequest request) throws ExecutionException, InterruptedException {
    ...
    public User createChild(CreateChildRequest request) throws ExecutionException, InterruptedException {
