...
public class WhatsAppIntegrationTest {
    ...
    void testOnboardingAndProofSubmission() throws Exception {
        ...
        String parentResponse = mockMvc.perform(post("/api/v1/auth/register")
        ...
        String childResponse = mockMvc.perform(post("/api/v1/children")
                        .contentType(MediaType.APPLICATION_JSON)
        ...
        Map<String, String> onboardingPayload = Map.of(
                "Body", onboardingCode,
                "From", "whatsapp:" + childPhoneNumber
        );
        ...
        mockMvc.perform(post("/api/v1/tasks?child_id=" + child.getId())
                        .contentType(MediaType.APPLICATION_JSON)
        ...
        Map<String, String> proofPayload = Map.of(
                "MediaUrl0", imageUrl,
                "From", "whatsapp:" + childPhoneNumber
        );
