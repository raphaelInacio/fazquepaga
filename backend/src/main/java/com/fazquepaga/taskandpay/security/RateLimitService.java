...
/**
 * Service interface for rate limiting functionality. Provides methods to check and consume rate
 * limit tokens.
 */
public interface RateLimitService {
     ...
     *
     * @param key The identifier for the rate limit bucket (e.g., IP address, user ID)
