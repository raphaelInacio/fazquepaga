...
class TaskServiceSubscriptionTest {
    ...
    @Test
    void testCreateRecurringTask_FreeUserWithinLimit_ShouldSucceed() throws ExecutionException, InterruptedException {
        // Given
    ...
    @Test
    void testCreateRecurringTask_PremiumUser_ShouldAllowUnlimited() throws ExecutionException, InterruptedException {
        // Given
        String childId = "child-id";
        String parentId = "parent-id";
        ...
        when(querySnapshot.getDocuments())
                .thenReturn(Collections.nCopies(99, Mockito.mock(QueryDocumentSnapshot.class)));
