...
@TestPropertySource(properties = {"ratelimit.enabled=false", "debug=true"})
@DirtiesContext
class AIQuotaIntegrationTest {
    ...
    @MockitoBean private AIQuotaRepository aiQuotaRepository;
    ...
    void shouldAllowRequest_whenQuotaAvailable() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/ai/tasks/suggestions?age=10").with(user(userPrincipal)))
