...
@WebMvcTest(controllers = IdentityController.class, includeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = SecurityConfig.class))
class IdentityControllerTest {
        ...
        void shouldGenerateOnboardingCodeSuccessfully() throws Exception {
                ...
                // When & Then
                mockMvc.perform(post("/api/v1/children/{childId}/onboarding-code", childId).param("parent_id",
                                parentId))
                                .andExpect(status().isOk())
