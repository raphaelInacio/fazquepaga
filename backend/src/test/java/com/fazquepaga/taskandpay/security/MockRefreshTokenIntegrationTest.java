...
class MockRefreshTokenIntegrationTest {
    ...
    private RecaptchaService
            recaptchaService; // Needed for IdentityController loading? Maybe not if I don't hit
    ...
    void shouldReturn401_withInvalidRefreshToken() throws Exception {
        ...
        when(refreshTokenService.validateAndRefresh(invalidToken)).thenReturn(Optional.empty());
