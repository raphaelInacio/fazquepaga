...
@WebMvcTest(
        ...
        properties = "asaas.webhook.accessToken=test-token")
@AutoConfigureMockMvc(
        addFilters =
                false) // Optional: Verify if we want security filters or not. We DO want to test
...
public class AsaasWebhookControllerTest {
    ...
    public void shouldActivateSubscriptionOnPaymentConfirmed() throws Exception {
        ...
        verify(subscriptionService)
                .activateSubscription("cus_000007342312", "sub123", "sess_12345");
    }
